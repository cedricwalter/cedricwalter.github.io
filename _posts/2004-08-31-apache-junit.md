...
tests are not obvious with complex object and or runtime environment).         <center> \| Constructor should not give
...
example.   <center> \| ![](images/stories/assert.gif) \| - <font face="Courier New" size="2">Assert methods are testing
...
“test“  *A trivial example:*   <center> \| Your first JUNIT testcase classe \| \|---\|
...
word <font face="Courier New" size="2">test will be found.   <center> \| In a JAVA main class: \| \|---\|
...
the stack and which test failed. \|   <center> \| JUnit Testrunner in Eclipse is a standar View \| \|---\|
\| ![](images/stories/junitineclipse.jpg) \|  <font size="5">**Testsuite**   Testsuite is a suite of testcase or method,
you can give this testsuite to a testrunner. # **Some particular TestSuite**   <center> \| **Multi threading test** If
