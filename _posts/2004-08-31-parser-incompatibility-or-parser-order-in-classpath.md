...
> **Solution 1:** Only use one parser [Apache Xerces](http://xml.apache.org/xerces-j/) (XML) and only one transformer [Saxon](http://saxon.sourceforge.net/) (XST) or [Apache Xalan](http://xml.apache.org/xalan-j/) (XST). It is not always possible since some 3rd party tools, like weblogic.jar or oracle.jar are coming with some crap inside…
> 
...
> 
> *java* -D*javax.xml.parsers.DocumentBuilderFactory=org.apache.xerces.jaxp.DocumentBuilderFactoryImpl -Djavax.xml.parsers.SAXParserFactory=org.apache.xerces.jaxp.SAXParserFactoryImpl -Djavax.xml.transform.TransformerFactory*=*com.icl.saxon.TransformerFactoryImpl*
> 
