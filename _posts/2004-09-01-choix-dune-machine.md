...
- Actuellement (25.11.2002) pour un débutant : égalité avec un léger avantage pour le caliber 30 ([review](images/Helico/caliber/review/review.htm)) et ([comparaison Raptor 30 et caliber 30](images/Helico/config/raptor30vsCaliber30.htm)) Raptor 30 v2.0 ou caliber 30, autre chose n’est pas à recommandé (century par ex ou JR venture) car ils sont trop peu courant.