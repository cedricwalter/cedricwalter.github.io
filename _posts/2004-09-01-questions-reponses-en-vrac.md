...
permalink: /hobbies/questions-reponses-en-vrac/
tags:
    - 'RC helicopter'
---
...
- **Comment commencer ?** Acheter un simulateur ([www.realflight.com](http://www.realflight.com/)) avant d’acheter un helicoptère. Si aprés 1 mois vous etes encore motiver alors c’est tout bon. Sinon il sera toujours possible de revendre le simulateur. Puis monter un patin d’écolage et s’adresser à un club pour les réglages et les premiers vols (c’est pas un jouet a mettre entre toute les mains et le premier vol est le plus dangeureux).
