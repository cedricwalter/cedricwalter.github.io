...
- You like an image and want to use it as a wallpaper? drag it on the desktop, a contextual windows will propose You to use it as wallpaper
 ...
 This is only a fraction of the possibility offered by KDE, [the official WIKI](http://wiki.kde.org/tiki-index.php) is available [here](http://wiki.kde.org/tiki-index.php)

 The best way to make KDE a try is to boot a free linux live CD (boot in 1 min and dont write any data on your disk, only use RAM memory) like [knoppix](www.knopper.net/knoppix) – [www.knopper.net/knoppix](www.knopper.net/knoppix) or [any other live-cd flavours](http://www.frozentech.com/content/livecd.php)
