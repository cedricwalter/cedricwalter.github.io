...
guid: 'https://waltercedric.com/new/?p=1463'
permalink: /internet/desktop-search-software/
image: /wp-content/uploads/2005/01/logoxp.gif
tags:
    - google
    - 'search engine'
---
...
- [Microsoft desktop search software,](http://beta.toolbar.msn.com/) ![](/assets/images/2005/01/ie_logo.gif)
- [Ask Jeeves desktop search software](http://sp.ask.com/docs/desktop/), (applications)
...
Lucidity (http://almaw.com/java/wiki/LuciditySearch) "<span style="font-style: italic;">Lucidity is an Intranet search application designed to make finding documents on big Samba shares on your office/home LAN easier. It will also happily index local files on your hard disk. 

<span style="font-style: italic;">The search system is powered by [Lucene](http://jakarta.apache.org/lucene/)<span style="font-style: italic;"> and runs as a background process. The user interface is browser-based and is provided by a J2EE web app written using [Tapestry](http://jakarta.apache.org/tapestry/)<span style="font-style: italic;">. You’ll need a servlet container like Jetty to run it, plus the JDK obviously."
...
- <http://www.enfish.com/> since 1998. Corporate usage