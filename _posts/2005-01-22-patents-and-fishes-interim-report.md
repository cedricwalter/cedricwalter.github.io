...
permalink: /open-source/patents-and-fishes-interim-report/
tags:
    - instructions
---
...
- Stay tuned to <http://demo.ffii.org/> and help us us reorient and enlarge the webdemo during the next days and weeks.
...
\[1\] cwalterw in[ http://aktiv.ffii.org/](< http://aktiv.ffii.org/>)  
Remark: if you would rather have this more localized   
(eg for alerts to events at http://kwiki.ffii.org/SwpatpenmiEn,  
...
supplemented by http://www.ffii.org/~arebenti/ekarte/).  
...
\[5\]  
http://ue.eu.int/uedocs/cms\_data/docs/2004/6/21/Councils%20rules%20of%20procedure.pdf  
\[6\] You may want to use the "My MEP" tool in http://aktiv.ffii.org/  
