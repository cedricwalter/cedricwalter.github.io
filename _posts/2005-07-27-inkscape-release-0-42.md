...
permalink: /open-source/inkscape-release-0-42/
tags:
    - capabilities
    - development
    - screenshots
...
Another tool that open source community can be proud: [INKSCAPE](http://www.inkscape.org/)

*Inkscape is an open source drawing tool with capabilities similar to Illustrator, Freehand, and CorelDraw that uses the* [*W3C*](http://www.w3.org/) *standard* [*scalable vector graphics* ](http://w3.org/Graphics/SVG/)*format (SVG). Some supported SVG features include basic shapes, paths, text, markers, clones, alpha blending, transforms, gradients, and grouping. In addition, Inkscape supports* [*Creative Commons*](http://www.creativecommons.org/) *meta-data, node-editing, layers, complex path operations, text-on-path, and SVG XML editing. It also imports several formats like EPS, Postscript, JPEG, PNG, BMP, and TIFF and exports PNG as well as multiple vector-based formats.*
