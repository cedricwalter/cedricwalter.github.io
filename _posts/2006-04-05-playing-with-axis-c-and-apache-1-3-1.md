...
| Apache 1.3in c:\\apache\\conf\\http.conf | Apache 2.0in c:\\apache\\conf\\http.conf |
|---|---|
...
<big>4. Now it is starting to be interesting,</big> both mod\_axis.dll and mod\_axis2.dll have dependencies to an old dll which do no more exist since windows 98 ! msjava.dll

You need to copy from Internet [msjava.dll](http://www.google.com/url?sa=U&start=1&q=http://www.dll-files.com/dllindex/dll-files.shtml%3Fmsjava&e=9797) into c:\\axis\\lib  
You also need to copy the xerces parser [xerces-c\_2\_2\_0.dll](http://webzila.com/dll/2/xerces-c_2_2_0.zip) into c:\\axis\\lib

![Axiss C++ required library in lib directory](/assets/images/2006/04/AxisCpp-lib-directory.png)  
  
<big>5. Create a file axiscpp.conf </big>(or search in zip distributions for a template of it) and copy it into c:\\axis  
...
<big>6. Go into c:/apache</big> and create a small batch file there 
...
<big>7. create a file</big> in c:\\axis\\conf\\server.wsdd
