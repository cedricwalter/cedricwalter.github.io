...
permalink: /java/bpel-repository-for-storing-process/
tags:
    - java
---

*As the market for Business Process Management (BPM) matures, organizations implementing BPM solutions observe the proliferation of BPEL (Business Process Execution Language), WSDL (Web Services Description Language), and other forms of XML documents. Storing, finding, and using these documents is laborious and inefficient. [BPEL Repository has several features](http://www.alphaworks.ibm.com/tech/bpelrepository) that resolve these problems:*
