...
permalink: /gadget/nas-home-glossary-of-terms/
tags:
    - 'PC and Hardware'
    - Storage
---
...
[CIFS](http://en.wikipedia.org/wiki/CIFS)  
...
<span style="FONT-STYLE: italic">The File Transfer Protocol (FTP) is a software standard for transferring computer files between machines with widely different operating systems. It belongs to the application layer of the Internet protocol suite. <big><font size="-1">  
