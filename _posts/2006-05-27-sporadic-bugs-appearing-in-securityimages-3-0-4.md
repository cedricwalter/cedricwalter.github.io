...
permalink: /joomla/sporadic-bugs-appearing-in-securityimages-3-0-4/
...
<span style="color: rgb(51, 51, 255); font-weight: bold;">3.0.5 (Patch)
...
- <span style="font-style: italic;">com\_contact (Joomla core)
- <span style="font-style: italic;">com\_login (Joomla core)
- <span style="font-style: italic;">com\_registration (Joomla core)
- akobookPlus
- akoCommenPlus

Other like <span style="font-weight: bold;">Community Builder, <span style="font-weight: bold;">Galleries, <span style="font-weight: bold;">JoomlaBoard will have to be supported by their own authors. Please contact them about that issue, I will document how to use the 4.0 in my wiki.
...
<span style="font-weight: bold;">AkobookPlus new languages files:

- Spanish translation, thanks to <span style="font-weight: bold;">Mariela Gonzalez <http://www.poolp.com/mariela>
