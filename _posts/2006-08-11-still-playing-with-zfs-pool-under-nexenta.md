...
permalink: /gadget/still-playing-with-zfs-pool-under-nexenta/
tags:
    - 'PC and Hardware'
    - Storage
---
...
|---|---|
| <span style="font-style: italic;"> # mkfile 64m /vault/disk1   <span style="font-style: italic;"> # mkfile 64m /vault/disk2   <span style="font-style: italic;"> # mkfile 64m /vault/disk3   <span style="font-style: italic;"> # mkfile 64m /vault/disk4   <span style="font-style: italic;"> # mkfile 64m /vault/disk5   <span style="font-style: italic;"> # mkfile 64m /vault/disk6   <span style="font-style: italic;"> # mkfile 64m /vault/disk7 | I create 7 virtual disk name disk1 to disk7 |
| <span style="font-style: italic;"> # zpool status    no pools available | check if there is any pool already defined…. |
