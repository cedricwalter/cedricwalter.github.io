...
permalink: /open-source/the-rule-of-the-game/
tags:
    - opensource
    - supporting
---

<span style="color: rgb(255, 0, 0); font-weight: bold;">Rule #1 Do not click everywhere without first looking at the link where you shall Go
...
Lets me show You what I mean: type "[Firefox](http://www.mozilla.com/en-US/firefox/)" in [Google](http://www.google.com) and observe the top link (both sponsored and the 5 highest result), they all lead You to page not affiliated or sponsored by [Google](http://www.google.com/) or affiliate by [Mozilla](http://www.mozilla.org/).  
These pages (I dont WANT to give You their URL in order to not improve their pagerank) are presenting in a shiny design links to [Google](http://www.google.com/) package or a link to the latest [Firefox](http://www.mozilla.com/en-US/firefox/) program.  
...
If they ever contribute money back…but they dont. So do not help these people, do not offer them a Yacht, but better make a $2 donations to the open source project directly. Now I would recommend [Firefox](http://www.mozilla.com/en-US/firefox/) to put something similar on [THEIR main site](http://www.mozilla.com/en-US/firefox/) (<http://www.mozilla.com/en-US/firefox/>) to make some money

<span style="font-weight: bold; color: rgb(255, 0, 0);">So give money to open source project and don’t help opportunist.

Beside fom that Firefox 2.0 is available trrought [FTP at the Mozilla server](ftp://ftp.mozilla.org/pub/mozilla.org/firefox/releases/2.0)  
