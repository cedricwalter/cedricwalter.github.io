...
guid: 'https://waltercedric.com/new/?p=2912'
permalink: /games/ps3-floating-point-crunching-eating-windows-wintel-machine-at-breakfeast/
header:
...
According [to Folding@ home, the PS3 raw cpu power is impressive.](http://fah-web.stanford.edu/cgi-bin/main.py?qtype=osstats)  
 Since 2000 and in less than a year on the market, it look like the Sony PS3 is 10 times more powerful than any PC. With 10 times less CPU, it process twice more [TFLOPS](http://de.wikipedia.org/wiki/Floating_Point_Operations_Per_Second)

| OS Type | Current [TFLOPS](http://de.wikipedia.org/wiki/Floating_Point_Operations_Per_Second)\* | Active CPUs | Total CPUs |
|---|---|---|---|
