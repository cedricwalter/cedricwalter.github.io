...
header:
  teaser: /assets/images/2007/07/wikipedia-logo.jpg
tags:
    - faster
    - optimization
    - performance
...
|---|---|
 ...
 forced all operation to use free &amp; open-source software only. Having commercial alternatives out of question, [WikiPedia](http://wikipedia.org/) had the challenging task to build efficient platform of freely  
