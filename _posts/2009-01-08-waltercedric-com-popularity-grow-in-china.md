...
- [http://demo.waltercedric.com](http://demo.waltercedric.com) A demo server for #Joomla! 1.0 extensions,
- [http://demo2.waltercedric.com](http://demo2.waltercedric.com) A demo server for #Joomla! 1.5 extensions,
- [http://mirror.waltercedric.com](http://mirror.waltercedric.com) My #Joomla! mirror with ALL release since the beginning,
- [http://bugs.waltercedric.com](http://bugs.waltercedric.com) Bug tracker for my extensions,
- [http://continuousbuildserver.waltercedric.com](http://continuousbuildserver.waltercedric.com) Continuous build server (TeamCity) for #Joomla! framework and components
...
- com\_akismet anti spammer solution using Bayesian filter web services
- com\_hashCash anti spammer crypto field added in forms
- com\_jmsitemap1.0.0.zip sitemap
- com\_log4PHP log4PHP logging
- com\_joomlaCloud Tag Clouds
- com\_openComment Ajax powered commenting system
- com\_securityImages maybe the most famous captcha generator for #Joomla!
- com\_sociable add content to sociable network
...
- com\_akismet anti spammer solution using Bayesian filter web services
- com\_securityImages maybe the most famous captcha generator for #Joomla!
- com\_minify make #Joomla! perform better by reducing number of http requests for #JavaScript and CSS
- ContinuousBuild4Joomla continuous build frameworks and tools for #Joomla and component as a whole [http://joomlacode.org/gf/project/continbuild4j/](http://joomlacode.org/gf/project/continbuild4j/)

Some links as example to JED

Security Images: THE CAPTCHA engine [http://extensions.joomla.org/extensions/access-&amp;-security/captcha/1211/details](http://extensions.joomla.org/extensions/access-&-security/captcha/1211/details)  
Askimet4Joomla! [http://extensions.joomla.org/extensions/access-&amp;-security/site-access/2576/details](http://extensions.joomla.org/extensions/access-&-security/site-access/2576/details)  
RssFriends [http://extensions.joomla.org/extensions/content-&amp;-news/rss-syndicate/2577/details](http://extensions.joomla.org/extensions/content-&-news/rss-syndicate/2577/details)  
MosSociable [http://extensions.joomla.org/extensions/clients-&amp;-groupware/social-bookmarking/2579/details](http://extensions.joomla.org/extensions/clients-&-groupware/social-bookmarking/2579/details)  
