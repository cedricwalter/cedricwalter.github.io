...
guid: 'https://waltercedric.com/new/?p=8193'
permalink: /development/update-maven-pom-version-on-git-checkout-in-teamcity/
header:
...
You do not have anymore to make pom version unique in your feature branch and commit pom version as they will change on the fly according to the branch name. You can now enjoy pull request in [Atlassian Stash](https://www.atlassian.com/software/stash) or [GitHub Enterprise](https://enterprise.github.com/ "GitHub social coding Git repositories").

pom.xml all stay to MASTER-SNAPSHOT in all branches

Soon I will show you hot to do this using a server side [GIT](http://git-scm.com/) hook in [Atlassian Stash](https://www.atlassian.com/software/stash) and with a client side [GIT](http://git-scm.com/) hook.
