...
The #Joomla! Project and the Production Leadership Team are proud to announce the release of [Joomla! 3.6](https://www.joomla.org/3/ "Joomla! 3.6") as the latest in the 3.x series.   
...
- And much more… To have a full list of the 3.6 features, please visit our [GitHub Repository.](https://github.com/joomla/joomla-cms/issues?q=milestone%3A%22Joomla+3.6.0%22+ "Joomla repository on Github")
...
[New installation instructions](https://docs.joomla.org/J3.x:Installing_Joomla) and [technical requirements](https://www.joomla.org/about-joomla/technical-requirements.html)
...
Note: Please read the [update instructions](https://docs.joomla.org/J3.x:Updating_from_an_existing_version) before updating.

Please remember to clear your browser’s cache after upgrading.  
If you find a bug in #Joomla! Please report it on the[ Joomla! Issue Tracker](https://issues.joomla.org/ "Joomla! Issue Tracker").
