...
guid: 'https://waltercedric.com/new/?p=8691'
permalink: /development/how-to-accept-bitcoin-on-a-any-website-using-electrum-and-letsencrypt/
---

This tutorial will show you how to accept Bitcoin on a website with SSL signed payment requests using [Electrum](https://electrum.org), required is a shell access and enough permission to install [electrum](https://electrum.org)
...
<tt>sudo apt-get install python3-setuptools python3-pyqt5 python3-pip</tt>

Install Electrum:  
<tt></tt>

<tt>sudo pip3 install https://download.electrum.org/3.0.3/Electrum-3.0.3.tar.gz</tt>
