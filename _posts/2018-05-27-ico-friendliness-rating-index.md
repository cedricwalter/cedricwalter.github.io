...
![](/assets/images/2018/05/ico-rating-switzerland.png)

Switzerland hosts the [fourth highest number of ICOs](https://icowatchlist.com/statistics/geo), after the U.S., the U.K., Russia.

The US Security Exchange Commission (SEC) is currently trying to categorize Cryptocurrencies, and landscape will changes a lot in the coming months. In between you can still apply the Howey Test ([online test](https://howey.oracles.org/)) to distinguish in which category your token apply. Your token can be either a Utility token or a security token:
...
[https://ico.tokens-economy.com](https://ico.tokens-economy.com/) display in an entertaining way the state of ICO worldwide legal framework and will be a work in progress for the next months to come.

![](/assets/images/2018/05/ico-rating-statistics.png)

I need your help! you can submit [map corrections by using this form](https://docs.google.com/forms/d/e/1FAIpQLScODPNSx0Ak5ZFfev5dObCp2QiezHXT6zYE8gbZRE7sWGD-2Q/viewform).