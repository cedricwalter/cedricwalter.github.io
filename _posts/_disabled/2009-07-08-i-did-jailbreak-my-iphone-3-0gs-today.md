...
- Winterboard, apply themes and skins to [get more funny spring board,](http://images.google.ch/images?hl=de&safe=off&client=firefox-a&rls=org.mozilla%3Aen-US%3Aofficial&um=1&sa=1&q=cydia+springboard&btnG=Bilder-Suche&aq=f&oq=) for example with the little big planet skins, they are really hundreds of them!   
     ![little.big.planet.cydia](/assets/images/2009/07/little.big_.planet.cydia_.jpg "little.big.planet.cydia") ![cydia.theme](/assets/images/2009/07/cydia.theme_.jpg "cydia.theme")
...
- **Multitasking support**, dead simple: press Home 2 second to put app in background, 2 second more to disabled background, I did not see any huge power drain differences by running 2 instant messaging apps: [Skype](http://www.skype.com) and [Nimbuzz](http://www.nimbuzz.com/) 2 hours without interruption. The only real issue that must be confirmed is that the iPhone get really hot in the back. I would suspect that Apple is aware of this problem and did not switch back grounding application for this reason.
...
- [Download for windows](http://purplera1n.com/purplera1n.exe)
- [Download for MAC](http://purplera1n.com/purplera1n.zip)

Run the exe while having your iPhone connected through USB, click on the button “make it ra1n”

The iPhone will reboot and a new icon “Freeze” will appear. Click on it to install [Cydia \[WikiPedia\]](http://en.wikipedia.org/wiki/Cydia_%28application%29). The operation take less than 1 minute
