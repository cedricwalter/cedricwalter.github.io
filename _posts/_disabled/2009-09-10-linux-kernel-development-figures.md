...
> 
> The kernel code base has grown by over 2.7 million lines The overall picture shows a robust development community which c continues to grow both in size and in productivity. source <http://www.linuxfoundation.org/publications/whowriteslinux.pdf>