...
![hdmi_logo](/assets/images/2010/07/hdmi_logo_ee99ed815a136489441ffa27e05770c2.jpg "hdmi_logo")

# In short:**

Any certified HDMI cable will generally work fine, but use Category 2 rated cables if you want guaranteed 1080p throughput. According to the HDMI website, Category 2 cables are required not only to guarantee 1080P Full HD but also for high refresh rates and deep color. Don’t pay for any other imaginary added quality (Monster cable are famous for that), they simply are not any better.

From the [HDMI.org](http://www.hdmi.org) website ([FAQ](http://www.hdmi.org/learningcenter/faq.aspx)):
...
Since my Samsung C8700 has 4 HDMI port, I did order 2 [High Speed M-Cab HDMI 1.4 cable for 35CHF each!](http://digitec.ch/ProdukteDetails2.aspx?Reiter=Details&Artikel=187199)

![mcab.de.hdmi.1,4](/assets/images/2010/07/mcab.de_.hdmi_.14.jpg "mcab.de.hdmi.1,4")

High Speed HDMI cable with Ethernet (HDMI 1.4) is the newest HDMI   
standard and supports the following new HDMI features :

- HDMI Ethernet Channel
- Audio Return Channel
- 3D support with a resolution up to 1080p
- 4 times higher resolutions as 1080p (max. 4096 x 2160 by 24Hz)
- Supports more color spaces as DSC and sYCC601   
    High Speed HDMI cable with Ethernet (HDMI 1.4) come up with all   
    features according to the High Speed HDMI cable standard as well   
    which are for example : 
    - Deep Color
    - x.v. Color

[Datasheet](http://www.mcab.de/createpdf.php?id=7300045)