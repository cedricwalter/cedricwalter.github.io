...
![samsung.c8700](/assets/images/2010/08/samsung.c8700.jpg "samsung.c8700")
...
So all your peer to peer ([Bittorent](http://www.bittorrent.com/), [eMule](http://www.emule-project.net)) video found legally (or illegally on internet) have a lot of chance to be not playable at all. In fact these Samsung LED TV are FAR away from a [VideoLan (VLC)](http://www.videolan.org/) solution.

Only the codec below in the manual are programmed to play – and that is through the Samsung PC Share program.

[![samsung.supported.video.codec](/assets/images/2010/08/samsung.supported.video_.codec_thumb_f53776332eec1eef42bee7674f1df62d.png "samsung.supported.video.codec")](/assets/images/2010/08/samsung.supported.video_.codec_5ae47d8ee65f94540f661fd06a014e1b.png)

(table extracted from the manual of a Samsung 8700 3D TV)

## And what do I use?

Nothing for now on my TV, I have a computer hook to a projector and use [VLC](http://www.videolan.org/) 100% of the time. I am not for a dedicated player like the pop-corn C200 as it has way too many issues (stability, heat, supported codec), my next move would be to buy a small Atom/Ion 2 like the Shuttle XS35GT

![shuttle.XS35GT.atom.ion](/assets/images/2010/08/shuttle.XS35GT.atom_.ion_.jpg "shuttle.XS35GT.atom.ion")
