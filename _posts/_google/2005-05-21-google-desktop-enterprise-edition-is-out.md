...
| ![](/assets/images/2005/05/googledesktopsearchlogo.gif) | What are the features of [Google desktop enterprise edition](http://desktop.google.com/enterprise/index.html), and why You may prefer use it, as a simple user, to the [Google desktop public edition](http://desktop.google.com/) |
|---|---|

- It is free! as [all other Google search products](http://www.google.com/options/)…
...
It can be download free of charge at [http://desktop.google.com/enterprise/](http://desktop.google.com/enterprise/)

Last but not least, to unleash the power of Google desktop, some internet page are providing some very good tips an tricks like for example:  [Google Desktop Search Tips](http://users.tns.net/~skingery/firefox/GDS_Tips.html) 
