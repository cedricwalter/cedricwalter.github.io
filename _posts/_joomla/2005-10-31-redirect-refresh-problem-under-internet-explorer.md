...
My internet page has under it’s root
directory [<font color="#800080">http://www.waltercedric.com](https://waltercedric.com/new/?p=45) an index.html file
which redirect You to #Joomla [http://www.waltercedric.com/Mambo/](/Mambo/)
...
Firefox has no difficulties with the file above. After a quick Look at
the [W3C consortium for HTML normalisation](http://www.w3.org/MarkUp/), I found the following code
...
So to resume, a coding error, lazy standard and **ME** only testing under firefox…I apologize for inconvenience…and will
try to avoid such situation in future.