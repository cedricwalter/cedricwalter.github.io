...
Securityimages patches for #Joomla! 1.0.12 can e found in my download section!
...
| You are using #Joomla! 1.0.11 | 1. First upgrade to #Joomla! 1.0.12 using <small style="font-family: Courier New,Courier,monospace;">Joomla\_1.0.11\_to\_1.0.12-Stable-Patch\_Package.zip </small>from [www.joomla.org](http://www.joomla.org/) 2. Then apply my #Joomla! core patches:       <small><span style="font-family: Courier New,Courier,monospace;">JoomlaPatches1.0.12-v1.0.x for securityimages 3.0.8 only.zip</small> or        <small><span style="font-family: Courier New,Courier,monospace;">JoomlaPatches1.0.12-v1.0.0 for securityimages 4.x only.zip       </small>depending on Your SecuriyImages version |
