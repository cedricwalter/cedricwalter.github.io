---
id: 690
title: 'Thanks to the open source community!'
...
|---|---|---|
| [**![](/assets/images/2004/09/php2.gif)**](http://www.php.net/) | **PHP** scripting language | [www.php.net](http://www.php.net/) |
| [**![](/assets/images/2004/09/gimp.gif)**](http://www.gimp.org/) | **GIMP** graphical editor, as powerful as photoshop | [www.gimp.org](http://www.gimp.org/) |
| **![](/assets/images/2004/09/jedit.gif)** | **Jedit** The best JAVA Text editor | [www.jedit.org](http://www.jedit.org/) |
| **![](/assets/images/2004/09/mysql.gif)** | **MySQL** Database | [www.mysql.net](http://www.mysql.net/) |
| **![](/assets/images/2004/08/linux.gif)** | **Suse 9.0** my operating system | [www.suse.com](http://www.suse.com/) |
| **VirtualDub** | Video editing solutions | [www.virtualdub.org](http://www.virtualdub.org/) |
| **PHP** |  | [www.php-free.de](http://www.php-free.de/) |
| **Opera** | My Favorite browser, not open source but at least   exist on nearly all platforms. | [http://www.opera.com](http://www.opera.com/)    <http://users.westelcom.com/jsegur/> |
| **And others…** |  |  |

[![](http://aful.org/images/patent_square.gif)](http://petition.eurolinux.org/)   
