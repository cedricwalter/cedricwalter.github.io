...
- **Component already using com\_hashcash:** com\_akobook 3.42 and hashcash1.0 **and** com\_akocomment 2.0 and hashcash 1.0
...
<font face="Courier New" size="2">Hvalue = Crypt(UserSessionID + mosConfig\_absolute\_path + UserBrowserAgent + TodayDate(F j, Y, g a))
