...
Use [DCEVM](http://ssw.jku.at/dcevm) and add java fields, methods, classes and use them without restarting your application server, it’s a modification of the HotSpot VM that allows unlimited class redefinition at run-time. You can add/remove fields and methods and change the super types of a class at run-time. The features of [DCEVM](http://ssw.jku.at/dcevm) are likely to be integrated in a future update of #Java 8 as part of [JEP 159](http://openjdk.java.net/jeps/159).
...
![](https://confluence.innoveo.com/download/attachments/15106441/image2015-1-14%2013%3A46%3A18.png?version=1&modificationDate=1421239968000&api=v2 "Technologies & Software Engineering > JAVA DCEVM > image2015-1-14 13:46:18.png")Click on both Replace by DCEVM and Install DCEVM as altjvm
