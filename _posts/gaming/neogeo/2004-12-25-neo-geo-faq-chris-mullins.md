...
1. Keyboards: There were two keyboards for the Neo-Geo; the first is a Mahjong controller with 8 buttons   
...
2. The Neo CD unit, which was supposed to attach on the Neo cart unit…relegated to vaporware status in   
    1993.
...
3. The last reason is if you have a Japanese/English switch on the back of your Neo-Geo (cart or CD),   
...
3. The Irritating Maze requires a TRACKBALL to play, and cannot be used with a joystick! Pop N’ Bounce   
    can be played with a paddle-type joystick, like in Arkanoid.
4. Mahjong Kyoretsuden and Mahjong Story are two different releases by two different companies, but   
    constitute the same game.
5. The Neo-Geo Cart system may have underwent a final cosmetic change, as in 1996 issues of NeoGeo   
...
6. Stakes Winner, by Saurus, has 80 Megs in Japanese, and 98 in English.
7. Dunk Dreams is known as Street Hoop is USA, and Street Slam in Europe. Also, Miracle Adventure in   
