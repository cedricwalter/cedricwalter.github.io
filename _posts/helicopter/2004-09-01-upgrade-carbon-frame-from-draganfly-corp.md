...
title: 'Upgrade carbon frame from  Draganfly corp.'
date: '2004-09-01T22:42:26+02:00'
...
| ![](/assets/images/2004/09/canopyCentralFrame.jpg)    Aerodynamic canopy, very light, the circuit board is    maintian by the four pylons. |
|---|
| ![](/assets/images/2004/09/motor_mount.JPG)    Maybe the motor mount has a little too much flexion. Let    see if it survive in a small crash. Note that the pinion is now    after the motor mount and no more inside the imaginary     inner circle. It will also be in contact with the ground in case    of crash. |
