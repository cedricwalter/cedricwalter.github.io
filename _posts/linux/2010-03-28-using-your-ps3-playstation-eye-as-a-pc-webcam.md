...
The **PlayStation Eye** is a webcam device by Sony Computer Entertainment for the PlayStation 3 video game console. It is the successor to the EyeToy for the PlayStation 2. In case you have one floating around that you do not use for gaming, why not trying to use it as a webcam? You can find them cheap everywhere on [ebay](http://www.ebay.com), [ricardo.ch](http://www.ricardo.ch), [leboncoin.fr](http://www.leboncoin.fr)
...
### ![windows_logo](/assets/images/2010/03/windows_logo_3.jpg "windows_logo") Windows XP, Windows Vista, Windows 7
...
### ![macos_logo](/assets/images/2010/03/macos_logo_3.png "macos_logo") MacOS

A working driver for MacOS can be downloaded from <http://webcam-osx.sourceforge.net/>

### ![tux](/assets/images/2010/03/tux_3.png "tux") Linux

Starting with Linux kernel 2.6.29, just plug your **PlayStation Eye** in a free USB port and enjoy. Tested under [OpenSuse 10.2](http://www.opensuse.org/)