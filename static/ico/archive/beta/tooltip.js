...
//name, rating, all, ongoing, upcoming, ended, regulation, taxation, accounting, aml, notes, sources, regulator, cryptocurrency
function tooltip(data) {
    ...
    let upcoming = data[4];
    let ended = data[5];
    let regulation = data[6];
    let taxation = data[7];
    let accounting = data[8];
    let aml = data[9];
    let notes = data[10];
    let sources = data[11];
    let regulator = data[12];
    let cryptocurrency = data[13];
